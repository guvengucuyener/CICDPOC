...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 172.20.20.19/24 | - |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet1 | P2P_ceos9_Ethernet4 | - | 10.255.255.13/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_ceos10_Ethernet4 | - | 10.255.255.15/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_ceos9_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_ceos10_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
router bgp 65104
   ...
   neighbor 10.255.255.12 description ceos9_Ethernet4
   neighbor 10.255.255.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.14 remote-as 65100
   neighbor 10.255.255.14 description ceos10_Ethernet4
