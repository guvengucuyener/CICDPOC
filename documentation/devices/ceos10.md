...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 172.20.20.22/24 | - |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet1 | P2P_ceos11_Ethernet2 | - | 10.255.255.2/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_ceos12_Ethernet2 | - | 10.255.255.6/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_ceos13_Ethernet2 | - | 10.255.255.10/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_ceos14_Ethernet2 | - | 10.255.255.14/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_ceos11_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_ceos12_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description P2P_ceos13_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description P2P_ceos14_Ethernet2
   no shutdown
   mtu 1500
   no switchport
