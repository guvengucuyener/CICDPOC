...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 172.20.20.29/24 | - |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | SERVER_server1_PCI1 | trunk | 11-12 | 4092 | - | - |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet1 | P2P_ceos9_Ethernet1 | - | 10.255.255.1/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_ceos10_Ethernet1 | - | 10.255.255.3/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_ceos9_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_ceos10_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description SERVER_server1_PCI1
   no shutdown
...
router bgp 65101
   ...
   neighbor 10.255.0.1 description ceos9_Loopback0
   neighbor 10.255.0.2 peer group EVPN-OVERLAY-PEERS
   neighbor 10.255.0.2 remote-as 65100
   neighbor 10.255.0.2 description ceos10_Loopback0
   neighbor 10.255.255.0 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.0 remote-as 65100
   neighbor 10.255.255.0 description ceos9_Ethernet1
   neighbor 10.255.255.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.2 remote-as 65100
   neighbor 10.255.255.2 description ceos10_Ethernet1
