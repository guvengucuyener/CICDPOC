...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 172.20.20.20/24 | - |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet1 | P2P_ceos9_Ethernet3 | - | 10.255.255.9/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_ceos10_Ethernet3 | - | 10.255.255.11/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_ceos9_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_ceos10_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
router bgp 65103
   ...
   neighbor 10.255.255.8 description ceos9_Ethernet3
   neighbor 10.255.255.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.10 remote-as 65100
   neighbor 10.255.255.10 description ceos10_Ethernet3
