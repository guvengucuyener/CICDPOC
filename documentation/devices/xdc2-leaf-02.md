...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 192.168.154.9/24 | 192.168.154.1 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet1 | P2P_xdc2-spine-01_Ethernet2 | - | 10.255.255.5/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_xdc2-spine-02_Ethernet2 | - | 10.255.255.7/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_xdc2-spine-01_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_xdc2-spine-02_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
router bgp 65102
   ...
   neighbor 10.255.255.4 description xdc2-spine-01_Ethernet2
   neighbor 10.255.255.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.6 remote-as 65100
   neighbor 10.255.255.6 description xdc2-spine-02_Ethernet2
