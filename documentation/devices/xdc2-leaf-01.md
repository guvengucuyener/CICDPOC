...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 192.168.154.3/24 | 192.168.154.1 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet1 | P2P_xdc2-spine-01_Ethernet1 | - | 10.255.255.1/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_xdc2-spine-02_Ethernet1 | - | 10.255.255.3/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_xdc2-spine-01_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_xdc2-spine-02_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
router bgp 65101
   ...
   neighbor 10.255.255.0 description xdc2-spine-01_Ethernet1
   neighbor 10.255.255.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.2 remote-as 65100
   neighbor 10.255.255.2 description xdc2-spine-02_Ethernet1
