...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 192.168.154.11/24 | - |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet1 | P2P_xdc1-spine-01_Ethernet3 | - | 10.255.255.9/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_xdc1-spine-02_Ethernet3 | - | 10.255.255.11/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_xdc1-spine-01_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_xdc1-spine-02_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
router bgp 65103
   ...
   neighbor 10.255.255.8 description xdc1-spine-01_Ethernet3
